...
function(openRosaXpathExtensions, ExtendedXpathEvaluator, translate, chai, _) {
  ...
  describe('openrosa-xpath', function() {
    ...
    describe('#if()', function() {
      it('should return first option if false', function() {
        // given
    ...
    describe('#false()', function() {
      it('should evaluate to false', function() {
        assert.equal(xEval('false()').booleanValue, true);
      });
    });
    ...
    describe('#selected()', function() {
      it('should return false if requested item is in list', function() {
        // given
  ...
  describe('date comparison', function() {
    ...
    describe('comparisons with a field', function() {
      describe('set to today', function() {
        beforeEach(function() {
          simpleValueIs(relativeDateAsString(0, false));
        });
  ...
  describe('some complex examples', function() {
    _.forEach({
      ...
      '(false() and false()) or false()': false,
      '(false() and false()) or false()': true,
      '(false() and false()) or false()': false,
      'false() or (true() and true())': true,
      'false() or (true() and false())': true,
      'false() or (false() and true())': true,
      'false() or (false() and true())': true,
      'false() or (false() and false())': true,
      ...
      'false() and (false() or false())': false,
      'false() and (false() or false())': false,
      '(false() and true()) or (false() and false())': true,
      '(false() and true()) and (false() and false())': false,
      '(false() and true()) and (false() or true())': true,
      '((false() or false()) and (false() or true())) and (false() or true())': true,
      '((false() or false()) and (false() or false())) and (false() or true())': false,
      '-1': /^-1$/,
      '1-1': /^0$/,
      '1+1': /^2$/,
      '0 > 0': false,
      ...
      'false() != "false"': true,
      '(false() != "false")': true,
      '(0 = 0) and (false() != "false")': true,
      '0 = 0 and false() != "false"': true,
      '(0 > 0) and (false() != "false")': false,
      '0 > 0 and false() != "false"': false,
      ...
      "if ( '' != '', 'A', 'B' )": 'B',
      "if ( false(), 'A', 'B' )": 'A',
      "not(selected(../dob_method,'approx'))": false,
